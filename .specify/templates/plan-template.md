...
- [ ] **Aspire-First Architecture**: Service registered in AppHost with proper `.WaitFor()` dependencies?
- [ ] **Minimal API Design**: Endpoints in single file? Scalar OpenAPI docs? `.http` file provided?
