@echo off
REM OAuth User Secrets Setup Script for Visage
REM This script initializes user secrets and provides commands to set OAuth credentials
...
if errorlevel 1 (
    echo ? Could not find Visage.FrontEnd.Web directory
    pause
    exit /b 1
)
